...
import { order6salebycat } from "../../../data/6monthsalebycat.js";
 ...
 // end am5.ready()
let temp2 = async function(test) {
am5.ready(async function() {

  console.log("ceci est la valeur de :" + test);
...
export { temp2 as graphbycat}; // export the am5 object as GraphSale 